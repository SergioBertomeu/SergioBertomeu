...
const [Nom] = {
  ...
  tecnologies: {
      ...
      basesDades: ["MongoDB", "MySQL", "PostgreSQL", "SQLite"],
      mobil: ["React Native", "Flutter"],
      devOps: ["AWS", "Docker🐳", "Nginx", "Jenkins"],
      disseny: ["Photoshop", "Illustrator", "InDesign"],
      hardware: ["Arduino", "Raspberry Pi"],
      altres: ["Firebase", "GraphQL", "Selenium", "Puppeteer", "Socket.IO"]
  },
